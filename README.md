...
7. FAQ 
How do I change the default scan range? 
Edit the app.py file and update the DEFAULT_PORT_RANGE variable. 
Can I run this on a public server? 
For security reasons, it is recommended to restrict access to trusted IPs only. Edit the app.py file 
to specify allowed IPs. 
8. Contact Information 
For further assistance, please contact: 
 Email: support@webportscanner.com 
 Phone: +62-857-5550-1234 
 Address: 2XR3+6HR, Sagulung Kota, Sagulung, Batam City, Riau Islands 29425, Indonesia 
